...
public class MS2_Tests_05 {
	...
	public void TableInsertionPreIndexing_33() throws Exception {
		...
		// record7: [a7, b1, c1, d3, e2, f1, g0]
		// record8: [a8, b0, c2, d0, e3, f2, g1]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("lqh21", "e", "e2"), ("001000010"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("lqh21", "g", "g7"), ("000000000"));
		// --------------------------------------------------------------------------
		String[] cols1 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o" };
		DBApp.createTable("y82", cols1);
		// To be indexed: [b, e, g, k, m, n, o], to be queried: [b0, e0, g4, k3, m7,
		// n11, o15].
		...
		// record10: [a10, b0, c1, d2, e0, f4, g3, h2, i1, j0, k10, l10, m10, n10, o10]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("y82", "b", "b0"), ("10101010101"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("y82", "e", "e0"), ("10000100001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("y82", "g", "g4"), ("00001000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("y82", "k", "k3"), ("00010000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("y82", "m", "m7"), ("00000001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("y82", "n", "n11"), ("00000000000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("y82", "o", "o15"), ("00000000000"));
		// --------------------------------------------------------------------------
		...
		// q13]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("j83s0", "c", "c1"), ("010010010010010010010010010010010010010010010010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("j83s0", "j", "j1"), ("010000000001000000000100000000010000000001000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("j83s0", "m", "m2"), ("001000000000000100000000000010000000000001000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("j83s0", "n", "n7"), ("000000010000000000000100000000000001000000000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("j83s0", "o", "o2"), ("001000000000000001000000000000001000000000000001"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("j83s0", "q", "q17"), ("000000000000000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_34() throws Exception {
		...
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("o8q", "c", "c1"), ("01001001001001001001001001001001001001001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("o8q", "e", "e0"), ("10000100001000010000100001000010000100001"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("o8q", "g", "g7"), ("00000000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols1 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q" };
		DBApp.createTable("v07", cols1);
		// To be indexed: [b, c, g, j, o, p, q], to be queried: [b0, c1, g1, j7, o6, p7,
		// q17].
		...
		// q5]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("v07", "b", "b0"), ("1010101010101010101010101010101010101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("v07", "c", "c1"), ("0100100100100100100100100100100100100100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("v07", "g", "g1"), ("0100000010000001000000100000010000001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("v07", "j", "j7"), ("0000000100000000010000000001000000000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("v07", "o", "o6"), ("0000001000000000000001000000000000001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("v07", "p", "p7"), ("0000000100000000000000010000000000000001"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("v07", "q", "q17"), ("0000000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_35() throws Exception {
		...
		// last 1 records:
		// record0: [a0, b0, c0, d0, e0, f0, g0]
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("y6", "b", "b0"),
				("1"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("y6", "c", "c1"),
				("0"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("y6", "d", "d1"),
				("0"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("y6", "g", "g7"), ("0"));
		// --------------------------------------------------------------------------
		...
		// record35: [a35, b1, c2, d3, e0, f5, g0]
		// record36: [a36, b0, c0, d0, e1, f0, g1]
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("i0", "c", "c0"),
				("1001001001001001001001001001001001001"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("i0", "d", "d2"),
				("0010001000100010001000100010001000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("i0", "e", "e3"),
				("0001000010000100001000010000100001000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("i0", "g", "g7"), ("0000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
		...
		// record27: [a27, b1, c0, d3, e2, f3, g6]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("n0u1y", "b", "b0"), ("1010101010101010101010101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("n0u1y", "c", "c0"), ("1001001001001001001001001001"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("n0u1y", "g", "g7"), ("0000000000000000000000000000"));
		// --------------------------------------------------------------------------
		...
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("s1", "c", "c1"),
				("0100100100100100100100100100100100100100100100100"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("s1", "e", "e1"),
				("0100001000010000100001000010000100001000010000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("s1", "f", "f2"),
				("0010000010000010000010000010000010000010000010000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("s1", "g", "g7"), ("0000000000000000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_36() throws Exception {
		...
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("jykg8", "e", "e0"), ("100001000010000100001000010000100001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("jykg8", "h", "h2"), ("001000000010000000100000001000000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("jykg8", "i", "i2"), ("001000000001000000001000000001000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("jykg8", "j", "j6"), ("000000100000000010000000001000000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("jykg8", "k", "k2"), ("001000000000010000000000100000000001"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("jykg8", "l", "l12"), ("000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
		...
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("i8804", "b", "b0"), ("1010101010101010101010101010101010101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("i8804", "c", "c0"), ("1001001001001001001001001001001001001001"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("i8804", "h", "h8"), ("0000000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_37() throws Exception {
		...
		// record24: [a24, b0, c0, d0, e4, f0, g3, h0, i6, j4, k2, l0]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("gm6", "d", "d1"), ("0100010001000100010001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("gm6", "f", "f2"), ("0010000010000010000010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("gm6", "g", "g1"), ("0100000010000001000000100"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("gm6", "l", "l12"), ("0000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols1 = { "a", "b", "c", "d", "e", "f", "g" };
		...
		// record13: [a13, b1, c1, d1, e3, f1, g6]
		// record14: [a14, b0, c2, d2, e4, f2, g0]
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("lu", "b", "b0"),
				("101010101010101"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("lu", "c", "c0"),
				("100100100100100"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("lu", "e", "e2"),
				("001000010000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("lu", "f", "f4"),
				("000010000010000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("lu", "g", "g7"), ("000000000000000"));
		// --------------------------------------------------------------------------
		...
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("fx7", "b", "b0"), ("10101010101010101010101010101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("fx7", "g", "g4"), ("00001000000100000010000001000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("fx7", "i", "i3"), ("00010000000010000000010000000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("fx7", "k", "k5"), ("00000100000000001000000000010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("fx7", "l", "l3"), ("00010000000000010000000000010000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("fx7", "n", "n14"), ("00000000000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols3 = { "a", "b", "c", "d", "e", "f", "g" };
		...
		// record7: [a7, b1, c1, d3, e2, f1, g0]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("p234l", "d", "d0"), ("10001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("p234l", "e", "e0"), ("10000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("p234l", "f", "f4"), ("00001000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("p234l", "g", "g7"), ("00000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_38() throws Exception {
		...
		// record20: [a20, b0, c2, d0, e0, f2, g6]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("w62", "b", "b0"), ("101010101010101010101"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("w62", "c", "c0"), ("100100100100100100100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("w62", "d", "d2"), ("001000100010001000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("w62", "e", "e3"), ("000100001000010000100"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("w62", "g", "g7"), ("000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols1 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o" };
		DBApp.createTable("t84", cols1);
		// To be indexed: [b, f, g, h, l, m, n, o], to be queried: [b0, f1, g4, h6, l6,
		// m4, n6, o15].
		...
		// record5: [a5, b1, c2, d1, e0, f5, g5, h5, i5, j5, k5, l5, m5, n5, o5]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("t84", "b", "b0"), ("101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("t84", "f", "f1"), ("010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("t84", "g", "g4"), ("000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("t84", "h", "h6"), ("000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("t84", "l", "l6"), ("000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("t84", "m", "m4"), ("000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("t84", "n", "n6"), ("000000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("t84", "o", "o15"), ("000000"));
		// --------------------------------------------------------------------------
		String[] cols2 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o" };
		DBApp.createTable("xq2", cols2);
		// To be indexed: [b, e, f, h, j, k, l, n, o], to be queried: [b0, e2, f0, h5,
		// j6, k8, l3, n11, o15].
		...
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("xq2", "b", "b0"), ("10101010101010101010101010101010101010101"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("xq2", "e", "e2"), ("00100001000010000100001000010000100001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("xq2", "f", "f0"), ("10000010000010000010000010000010000010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("xq2", "h", "h5"), ("00000100000001000000010000000100000001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("xq2", "j", "j6"), ("00000010000000001000000000100000000010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("xq2", "k", "k8"), ("00000000100000000001000000000010000000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("xq2", "l", "l3"), ("00010000000000010000000000010000000000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("xq2", "n", "n11"), ("00000000000100000000000001000000000000010"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("xq2", "o", "o15"), ("00000000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
		...
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("mfr", "b", "b0"), ("10101010101010101010101010101010101010101010101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("mfr", "c", "c0"), ("10010010010010010010010010010010010010010010010010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("mfr", "d", "d0"), ("10001000100010001000100010001000100010001000100010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("mfr", "h", "h3"), ("00010000000100000001000000010000000100000001000000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("mfr", "j", "j10"), ("00000000000000000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_39() throws Exception {
		...
		// record6: [a6, b0, c0, d2, e1, f0, g6]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("m383m", "b", "b0"), ("1010101"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("m383m", "c", "c1"), ("0100100"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("m383m", "g", "g7"), ("0000000"));
		// --------------------------------------------------------------------------
		...
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("a6myw", "b", "b0"), ("10101010101010101010101"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("a6myw", "c", "c1"), ("01001001001001001001001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("a6myw", "h", "h4"), ("00001000000010000000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("a6myw", "i", "i6"), ("00000010000000010000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("a6myw", "j", "j5"), ("00000100000000010000000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("a6myw", "k", "k11"), ("00000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols2 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r" };
		DBApp.createTable("nm", cols2);
		// To be indexed: [b, c, g, j, k, l, n, o, p, q, r], to be queried: [b0, c0, g3,
		// j7, k5, l9, n1, o13, p12, q6, r18].
		...
		// record8: [a8, b0, c2, d0, e3, f2, g1, h0, i8, j8, k8, l8, m8, n8, o8, p8, q8,
		// r8]
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("nm", "b", "b0"),
				("101010101"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("nm", "c", "c0"),
				("100100100"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("nm", "g", "g3"),
				("000100000"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("nm", "j", "j7"),
				("000000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("nm", "k", "k5"),
				("000001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("nm", "l", "l9"),
				("000000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("nm", "n", "n1"),
				("010000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("nm", "o", "o13"), ("000000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("nm", "p", "p12"), ("000000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("nm", "q", "q6"),
				("000000100"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("nm", "r", "r18"), ("000000000"));
		// --------------------------------------------------------------------------
		String[] cols3 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o" };
		DBApp.createTable("mpv8", cols3);
		// To be indexed: [b, c, d, f, g, h, k, m, n, o], to be queried: [b0, c0, d0,
		// f2, g5, h5, k9, m2, n0, o15].
		...
		// record38: [a38, b0, c2, d2, e3, f2, g3, h6, i2, j8, k5, l2, m12, n10, o8]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("mpv8", "b", "b0"), ("101010101010101010101010101010101010101"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("mpv8", "c", "c0"), ("100100100100100100100100100100100100100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("mpv8", "d", "d0"), ("100010001000100010001000100010001000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("mpv8", "f", "f2"), ("001000001000001000001000001000001000001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("mpv8", "g", "g5"), ("000001000000100000010000001000000100000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("mpv8", "h", "h5"), ("000001000000010000000100000001000000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("mpv8", "k", "k9"), ("000000000100000000001000000000010000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("mpv8", "m", "m2"), ("001000000000000100000000000010000000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("mpv8", "n", "n0"), ("100000000000001000000000000010000000000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("mpv8", "o", "o15"), ("000000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_40() throws Exception {
		...
		// To be indexed: [b, c, d, e, f, i, k, l, m, n, r, s], to be queried: [b0, c0,
		// d1, e0, f0, i5, k5, l4, m4, n0, r12, s19].
		...
		// p11, q10, r9, s8]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("tr5", "b", "b0"), ("1010101010101010101010101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("tr5", "c", "c0"), ("1001001001001001001001001001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("tr5", "d", "d1"), ("0100010001000100010001000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("tr5", "e", "e0"), ("1000010000100001000010000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("tr5", "f", "f0"), ("1000001000001000001000001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("tr5", "i", "i5"), ("0000010000000010000000010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("tr5", "k", "k5"), ("0000010000000000100000000001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("tr5", "l", "l4"), ("0000100000000000100000000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("tr5", "m", "m4"), ("0000100000000000010000000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("tr5", "n", "n0"), ("1000000000000010000000000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("tr5", "r", "r12"), ("0000000000001000000000000000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("tr5", "s", "s19"), ("0000000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols1 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o" };
		DBApp.createTable("v2", cols1);
		// To be indexed: [b, d, e, h, i, l, o], to be queried: [b0, d1, e3, h2, i1, l7,
		// o15].
		...
		// record34: [a34, b0, c1, d2, e4, f4, g6, h2, i7, j4, k1, l10, m8, n6, o4]
		// record35: [a35, b1, c2, d3, e0, f5, g0, h3, i8, j5, k2, l11, m9, n7, o5]
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("v2", "b", "b0"),
				("101010101010101010101010101010101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("v2", "d", "d1"),
				("010001000100010001000100010001000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("v2", "e", "e3"),
				("000100001000010000100001000010000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("v2", "h", "h2"),
				("001000000010000000100000001000000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("v2", "i", "i1"),
				("010000000010000000010000000010000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("v2", "l", "l7"),
				("000000010000000000010000000000010000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("v2", "o", "o15"), ("000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols2 = { "a", "b", "c", "d", "e", "f", "g" };
		...
		// record36: [a36, b0, c0, d0, e1, f0, g1]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("cedyt", "b", "b0"), ("1010101010101010101010101010101010101"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("cedyt", "d", "d0"), ("1000100010001000100010001000100010001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("cedyt", "e", "e3"), ("0001000010000100001000010000100001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("cedyt", "f", "f2"), ("0010000010000010000010000010000010000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("cedyt", "g", "g7"), ("0000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols3 = { "a", "b", "c", "d", "e", "f", "g" };
		...
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("pt8", "b", "b0"), ("10101010101010101010101010101010101010101010101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("pt8", "d", "d0"), ("10001000100010001000100010001000100010001000100010"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("pt8", "g", "g7"), ("00000000000000000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
		...
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("a18", "c", "c0"), ("100100100100100100100100100100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("a18", "d", "d2"), ("001000100010001000100010001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("a18", "e", "e0"), ("100001000010000100001000010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("a18", "h", "h0"), ("100000001000000010000000100000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("a18", "i", "i9"), ("000000000000000000000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_41() throws Exception {
		...
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("dck1", "d", "d1"), ("010001000100010001000100010001000100010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("dck1", "g", "g1"), ("010000001000000100000010000001000000100"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("dck1", "i", "i9"), ("000000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols1 = { "a", "b", "c", "d", "e", "f", "g" };
		...
		// record21: [a21, b1, c0, d1, e1, f3, g0]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("r2u", "b", "b0"), ("1010101010101010101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("r2u", "c", "c0"), ("1001001001001001001001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("r2u", "d", "d1"), ("0100010001000100010001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("r2u", "e", "e0"), ("1000010000100001000010"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("r2u", "g", "g7"), ("0000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols2 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l" };
		DBApp.createTable("a954", cols2);
		// To be indexed: [b, e, f, g, h, j, l], to be queried: [b0, e3, f3, g4, h2, j6,
		// l12].
		...
		// record4: [a4, b0, c1, d0, e4, f4, g4, h4, i4, j4, k4, l4]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("a954", "b", "b0"), ("10101"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("a954", "e", "e3"), ("00010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("a954", "f", "f3"), ("00010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("a954", "g", "g4"), ("00001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("a954", "h", "h2"), ("00100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("a954", "j", "j6"), ("00000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("a954", "l", "l12"), ("00000"));
		// --------------------------------------------------------------------------
		String[] cols3 = { "a", "b", "c", "d", "e", "f", "g" };
		...
		// record28: [a28, b0, c1, d0, e3, f4, g0]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("xq7", "b", "b0"), ("10101010101010101010101010101"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("xq7", "c", "c1"), ("01001001001001001001001001001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("xq7", "d", "d2"), ("00100010001000100010001000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("xq7", "e", "e3"), ("00010000100001000010000100001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("xq7", "f", "f2"), ("00100000100000100000100000100"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("xq7", "g", "g7"), ("00000000000000000000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_42() throws Exception {
		...
		// record27: [a27, b1, c0, d3, e2, f3, g6]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("mch3", "d", "d0"), ("1000100010001000100010001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("mch3", "e", "e2"), ("0010000100001000010000100001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("mch3", "f", "f1"), ("0100000100000100000100000100"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("mch3", "g", "g7"), ("0000000000000000000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_43() throws Exception {
		...
		// To be indexed: [c, g, h, i, j, k, l], to be queried: [c1, g4, h6, i6, j1, k9,
		// l12].
		...
		// record0: [a0, b0, c0, d0, e0, f0, g0, h0, i0, j0, k0, l0]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("vl63", "c", "c1"), ("0"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("vl63", "g", "g4"), ("0"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("vl63", "h", "h6"), ("0"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("vl63", "i", "i6"), ("0"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("vl63", "j", "j1"), ("0"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("vl63", "k", "k9"), ("0"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("vl63", "l", "l12"), ("0"));
		// --------------------------------------------------------------------------
		String[] cols1 = { "a", "b", "c", "d", "e", "f", "g" };
		...
		// record14: [a14, b0, c2, d2, e4, f2, g0]
		// record15: [a15, b1, c0, d3, e0, f3, g1]
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("de", "f", "f4"),
				("0000100000100000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("de", "g", "g7"), ("0000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols2 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n" };
		DBApp.createTable("p3x0", cols2);
		// To be indexed: [b, c, d, e, f, j, k, l, n], to be queried: [b0, c1, d2, e2,
		// f4, j3, k5, l9, n14].
		...
		// record12: [a12, b0, c0, d0, e2, f0, g5, h4, i3, j2, k1, l0, m12, n12]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("p3x0", "b", "b0"), ("1010101010101"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("p3x0", "c", "c1"), ("0100100100100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("p3x0", "d", "d2"), ("0010001000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("p3x0", "e", "e2"), ("0010000100001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("p3x0", "f", "f4"), ("0000100000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("p3x0", "j", "j3"), ("0001000000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("p3x0", "k", "k5"), ("0000010000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("p3x0", "l", "l9"), ("0000000001000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("p3x0", "n", "n14"), ("0000000000000"));
		// --------------------------------------------------------------------------
		String[] cols3 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q" };
		DBApp.createTable("zyu", cols3);
		// To be indexed: [b, c, f, g, h, i, m, o, q], to be queried: [b0, c1, f1, g5,
		// h1, i0, m9, o0, q17].
		...
		// p9, q8]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("zyu", "b", "b0"), ("10101010101010101010101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("zyu", "c", "c1"), ("01001001001001001001001001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("zyu", "f", "f1"), ("01000001000001000001000001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("zyu", "g", "g5"), ("00000100000010000001000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("zyu", "h", "h1"), ("01000000010000000100000001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("zyu", "i", "i0"), ("10000000010000000010000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("zyu", "m", "m9"), ("00000000010000000000001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("zyu", "o", "o0"), ("10000000000000010000000000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("zyu", "q", "q17"), ("00000000000000000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_44() throws Exception {
		...
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("esy", "b", "b0"), ("101010101010101010101010101010101010101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("esy", "d", "d0"), ("100010001000100010001000100010001000100010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("esy", "e", "e2"), ("001000010000100001000010000100001000010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("esy", "g", "g3"), ("000100000010000001000000100000010000001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("esy", "i", "i7"), ("000000010000000010000000010000000010000000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("esy", "n", "n14"), ("000000000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_45() throws Exception {
		...
		// To be indexed: [b, d, f, h, k, l, m, o], to be queried: [b0, d2, f1, h4, k6,
		// l3, m6, o15].
		...
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("x5", "b", "b0"),
				("1010101010101010101010101010101010101010101010101"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("x5", "d", "d2"),
				("0010001000100010001000100010001000100010001000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("x5", "f", "f1"),
				("0100000100000100000100000100000100000100000100000"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("x5", "h", "h4"),
				("0000100000001000000010000000100000001000000010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("x5", "k", "k6"),
				("0000001000000000010000000000100000000001000000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("x5", "l", "l3"),
				("0001000000000001000000000001000000000001000000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("x5", "m", "m6"),
				("0000001000000000000100000000000010000000000001000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("x5", "o", "o15"), ("0000000000000000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_46() throws Exception {
		...
		// To be indexed: [b, c, d, f, i, j, n], to be queried: [b0, c0, d1, f2, i5, j8,
		// n14].
		...
		// record9: [a9, b1, c0, d1, e4, f3, g2, h1, i0, j9, k9, l9, m9, n9]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("qv9", "b", "b0"), ("1010101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("qv9", "c", "c0"), ("1001001001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("qv9", "d", "d1"), ("0100010001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("qv9", "f", "f2"), ("0010000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("qv9", "i", "i5"), ("0000010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("qv9", "j", "j8"), ("0000000010"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("qv9", "n", "n14"), ("0000000000"));
		// --------------------------------------------------------------------------
		String[] cols1 = { "a", "b", "c", "d", "e", "f", "g" };
		...
		// record41: [a41, b1, c2, d1, e1, f5, g6]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("w08f7", "b", "b0"), ("101010101010101010101010101010101010101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("w08f7", "c", "c1"), ("010010010010010010010010010010010010010010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("w08f7", "d", "d2"), ("001000100010001000100010001000100010001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("w08f7", "f", "f2"), ("001000001000001000001000001000001000001000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("w08f7", "g", "g7"), ("000000000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
		...
		// record12: [a12, b0, c0, d0, e2, f0, g5, h4]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("dtn", "b", "b0"), ("1010101010101"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("dtn", "g", "g5"), ("0000010000001"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("dtn", "h", "h8"), ("0000000000000"));
		// --------------------------------------------------------------------------
		String[] cols3 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r",
				"s", "t" };
		DBApp.createTable("y0l89", cols3);
		// To be indexed: [d, e, i, j, l, n, o, p, q, t], to be queried: [d0, e3, i2,
		// j8, l9, n11, o1, p12, q10, t20].
		...
		// p12, q12, r12, s12, t12]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("y0l89", "d", "d0"), ("1000100010001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("y0l89", "e", "e3"), ("0001000010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("y0l89", "i", "i2"), ("0010000000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("y0l89", "j", "j8"), ("0000000010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("y0l89", "l", "l9"), ("0000000001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("y0l89", "n", "n11"), ("0000000000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("y0l89", "o", "o1"), ("0100000000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("y0l89", "p", "p12"), ("0000000000001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("y0l89", "q", "q10"), ("0000000000100"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("y0l89", "t", "t20"), ("0000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_47() throws Exception {
		...
		// record33: [a33, b1, c0, d1, e3, f3, g5]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("j5tz", "c", "c1"), ("0100100100100100100100100100100100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("j5tz", "e", "e0"), ("1000010000100001000010000100001000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("j5tz", "g", "g7"), ("0000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
		...
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("cm", "b", "b0"),
				("1010101010101010101010101010101010101010101"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("cm", "c", "c0"),
				("1001001001001001001001001001001001001001001"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("cm", "i", "i9"), ("0000000000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_48() throws Exception {
		...
		// To be indexed: [b, c, d, e, i, j, k, n, o], to be queried: [b0, c1, d2, e0,
		// i1, j8, k7, n6, o15].
		...
		// record37: [a37, b1, c1, d1, e2, f1, g2, h5, i1, j7, k4, l1, m11, n9, o7]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ovc0", "b", "b0"), ("10101010101010101010101010101010101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ovc0", "c", "c1"), ("01001001001001001001001001001001001001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ovc0", "d", "d2"), ("00100010001000100010001000100010001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ovc0", "e", "e0"), ("10000100001000010000100001000010000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ovc0", "i", "i1"), ("01000000001000000001000000001000000001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ovc0", "j", "j8"), ("00000000100000000010000000001000000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ovc0", "k", "k7"), ("00000001000000000010000000000100000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ovc0", "n", "n6"), ("00000010000000000000100000000000001000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("ovc0", "o", "o15"), ("00000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols1 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m" };
		DBApp.createTable("v63", cols1);
		// To be indexed: [d, e, f, g, h, i, j, m], to be queried: [d0, e2, f0, g1, h3,
		// i4, j4, m13].
		...
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("v63", "d", "d0"), ("10001000100010001000100010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("v63", "e", "e2"), ("00100001000010000100001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("v63", "f", "f0"), ("10000010000010000010000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("v63", "g", "g1"), ("01000000100000010000001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("v63", "h", "h3"), ("00010000000100000001000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("v63", "i", "i4"), ("00001000000001000000001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("v63", "j", "j4"), ("00001000000000100000000010"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("v63", "m", "m13"), ("00000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols2 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r",
				"s" };
		DBApp.createTable("mke4", cols2);
		// To be indexed: [b, e, g, h, j, l, n, o, p, r, s], to be queried: [b0, e0, g2,
		// h5, j0, l7, n2, o5, p2, r11, s19].
		...
		// q0, r16, s15]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("mke4", "b", "b0"), ("10101010101010101010101010101010101"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("mke4", "e", "e0"), ("10000100001000010000100001000010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("mke4", "g", "g2"), ("00100000010000001000000100000010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("mke4", "h", "h5"), ("00000100000001000000010000000100000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("mke4", "j", "j0"), ("10000000001000000000100000000010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("mke4", "l", "l7"), ("00000001000000000001000000000001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("mke4", "n", "n2"), ("00100000000000001000000000000010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("mke4", "o", "o5"), ("00000100000000000000100000000000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("mke4", "p", "p2"), ("00100000000000000010000000000000001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("mke4", "r", "r11"), ("00000000000100000000000000000100000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("mke4", "s", "s19"), ("00000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols3 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o" };
		DBApp.createTable("ux", cols3);
		// To be indexed: [b, f, g, i, l, n, o], to be queried: [b0, f2, g1, i3, l7,
		// n11, o15].
		...
		// record9: [a9, b1, c0, d1, e4, f3, g2, h1, i0, j9, k9, l9, m9, n9, o9]
		// record10: [a10, b0, c1, d2, e0, f4, g3, h2, i1, j0, k10, l10, m10, n10, o10]
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("ux", "b", "b0"),
				("10101010101"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("ux", "f", "f2"),
				("00100000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("ux", "g", "g1"),
				("01000000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("ux", "i", "i3"),
				("00010000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("ux", "l", "l7"),
				("00000001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ux", "n", "n11"), ("00000000000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("ux", "o", "o15"), ("00000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_49() throws Exception {
		...
		// To be indexed: [b, c, d, e, g, k, m, n], to be queried: [b0, c0, d0, e3, g1,
		// k1, m2, n14].
		...
		// record3: [a3, b1, c0, d3, e3, f3, g3, h3, i3, j3, k3, l3, m3, n3]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("sfz", "b", "b0"), ("1010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("sfz", "c", "c0"), ("1001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("sfz", "d", "d0"), ("1000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("sfz", "e", "e3"), ("0001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("sfz", "g", "g1"), ("0100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("sfz", "k", "k1"), ("0100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("sfz", "m", "m2"), ("0010"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("sfz", "n", "n14"), ("0000"));
		// --------------------------------------------------------------------------
		String[] cols1 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o" };
		...
		// record39: [a39, b1, c0, d3, e4, f3, g4, h7, i3, j9, k6, l3, m0, n11, o9]
		// record40: [a40, b0, c1, d0, e0, f4, g5, h0, i4, j0, k7, l4, m1, n12, o10]
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("b9", "d", "d2"),
				("00100010001000100010001000100010001000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("b9", "h", "h4"),
				("00001000000010000000100000001000000010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("b9", "l", "l10"), ("00000000001000000000001000000000001000000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("b9", "o", "o15"), ("00000000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols2 = { "a", "b", "c", "d", "e", "f", "g" };
		...
		// record43: [a43, b1, c1, d3, e3, f1, g1]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("tt00l", "d", "d1"), ("01000100010001000100010001000100010001000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("tt00l", "e", "e0"), ("10000100001000010000100001000010000100001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("tt00l", "f", "f2"), ("00100000100000100000100000100000100000100000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("tt00l", "g", "g7"), ("00000000000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_50() throws Exception {
		...
		// To be indexed: [d, l, n, q, r, s, t], to be queried: [d1, l9, n1, q2, r6, s4,
		// t20].
		...
		// p9, q8, r7, s6, t5]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("vk6", "d", "d1"), ("01000100010001000100010001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("vk6", "l", "l9"), ("00000000010000000000010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("vk6", "n", "n1"), ("01000000000000010000000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("vk6", "q", "q2"), ("00100000000000000001000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("vk6", "r", "r6"), ("00000010000000000000000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("vk6", "s", "s4"), ("00001000000000000000000100"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("vk6", "t", "t20"), ("00000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols1 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r",
				"s", "t" };
		DBApp.createTable("nx0a", cols1);
		// To be indexed: [c, d, e, g, i, k, l, n, s, t], to be queried: [c1, d1, e1,
		// g5, i5, k9, l9, n10, s10, t20].
		...
		// r6, s6, t6]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("nx0a", "c", "c1"), ("0100100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("nx0a", "d", "d1"), ("0100010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("nx0a", "e", "e1"), ("0100001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("nx0a", "g", "g5"), ("0000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("nx0a", "i", "i5"), ("0000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("nx0a", "k", "k9"), ("0000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("nx0a", "l", "l9"), ("0000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("nx0a", "n", "n10"), ("0000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("nx0a", "s", "s10"), ("0000000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("nx0a", "t", "t20"), ("0000000"));
		// --------------------------------------------------------------------------
		String[] cols2 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r" };
		DBApp.createTable("v5p4s", cols2);
		// To be indexed: [c, d, e, g, j, n, p, r], to be queried: [c0, d2, e3, g4, j1,
		// n10, p14, r18].
		...
		// q3, r1]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("v5p4s", "c", "c0"), ("10010010010010010010010010010010010010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("v5p4s", "d", "d2"), ("00100010001000100010001000100010001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("v5p4s", "e", "e3"), ("00010000100001000010000100001000010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("v5p4s", "g", "g4"), ("00001000000100000010000001000000100000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("v5p4s", "j", "j1"), ("01000000000100000000010000000001000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("v5p4s", "n", "n10"), ("00000000001000000000000010000000000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("v5p4s", "p", "p14"), ("00000000000000100000000000000010000000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("v5p4s", "r", "r18"), ("00000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols3 = { "a", "b", "c", "d", "e", "f", "g" };
		...
		// record1: [a1, b1, c1, d1, e1, f1, g1]
		// record2: [a2, b0, c2, d2, e2, f2, g2]
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("qj", "b", "b0"),
				("101"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("qj", "d", "d1"),
				("010"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("qj", "g", "g7"), ("000"));
		// --------------------------------------------------------------------------
		...
		// record17: [a17, b1, c2, d1, e2, f5, g3]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("u25l9", "c", "c0"), ("100100100100100100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("u25l9", "e", "e3"), ("000100001000010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("u25l9", "f", "f4"), ("000010000010000010"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("u25l9", "g", "g7"), ("000000000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_51() throws Exception {
		...
		// To be indexed: [b, c, e, i, j, k, n, o, p, q, r, s], to be queried: [b0, c1,
		// e3, i3, j8, k0, n1, o0, p9, q14, r7, s19].
		...
		// record47: [a47, b1, c2, d3, e2, f5, g5, h7, i2, j7, k3, l11, m8, n5, o2, p15,
		// q13, r11, s9]
		// record48: [a48, b0, c0, d0, e3, f0, g6, h0, i3, j8, k4, l0, m9, n6, o3, p0,
		// q14, r12, s10]
		// record49: [a49, b1, c1, d1, e4, f1, g0, h1, i4, j9, k5, l1, m10, n7, o4, p1,
		// q15, r13, s11]
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("u1", "b", "b0"),
				("10101010101010101010101010101010101010101010101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("u1", "c", "c1"),
				("01001001001001001001001001001001001001001001001001"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("u1", "e", "e3"),
				("00010000100001000010000100001000010000100001000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("u1", "i", "i3"),
				("00010000000010000000010000000010000000010000000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("u1", "j", "j8"),
				("00000000100000000010000000001000000000100000000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("u1", "k", "k0"),
				("10000000000100000000001000000000010000000000100000"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("u1", "n", "n1"),
				("01000000000000010000000000000100000000000001000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("u1", "o", "o0"),
				("10000000000000010000000000000010000000000000010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("u1", "p", "p9"),
				("00000000010000000000000001000000000000000100000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("u1", "q", "q14"), ("00000000000000100000000000000001000000000000000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("u1", "r", "r7"),
				("00000001000000000000000001000000000000000001000000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("u1", "s", "s19"), ("00000000000000000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_52() throws Exception {
		...
		// record0: [a0, b0, c0, d0, e0, f0, g0]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("vn4vx", "e", "e0"), ("1"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("vn4vx", "f", "f0"), ("1"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("vn4vx", "g", "g7"), ("0"));
		// --------------------------------------------------------------------------
		String[] cols1 = { "a", "b", "c", "d", "e", "f", "g" };
		...
		// record2: [a2, b0, c2, d2, e2, f2, g2]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("i1b7y", "b", "b0"), ("101"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("i1b7y", "c", "c0"), ("100"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("i1b7y", "g", "g7"), ("000"));
		// --------------------------------------------------------------------------
		String[] cols2 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r" };
		DBApp.createTable("f59", cols2);
		// To be indexed: [b, c, f, g, k, m, o, r], to be queried: [b0, c0, f3, g0, k4,
		// m1, o8, r18].
		...
		// r5]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("f59", "b", "b0"), ("101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("f59", "c", "c0"), ("100100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("f59", "f", "f3"), ("000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("f59", "g", "g0"), ("100000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("f59", "k", "k4"), ("000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("f59", "m", "m1"), ("010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("f59", "o", "o8"), ("000000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("f59", "r", "r18"), ("000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_53() throws Exception {
		...
		// record25: [a25, b1, c1, d1, e0, f1, g4]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("cafe1", "b", "b0"), ("10101010101010101010101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("cafe1", "c", "c0"), ("10010010010010010010010010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("cafe1", "e", "e0"), ("10000100001000010000100001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("cafe1", "f", "f2"), ("00100000100000100000100000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("cafe1", "g", "g7"), ("00000000000000000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_54() throws Exception {
		...
		// record1: [a1, b1, c1, d1, e1, f1, g1]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("bkv", "b", "b0"), ("10"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("bkv", "c", "c0"), ("10"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("bkv", "d", "d2"), ("00"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("bkv", "e", "e1"), ("01"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("bkv", "g", "g7"), ("00"));
		// --------------------------------------------------------------------------
		...
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("uzcl", "c", "c1"), ("0100100100100100100100100100100100100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("uzcl", "j", "j7"), ("0000000100000000010000000001000000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("uzcl", "k", "k0"), ("1000000000010000000000100000000001000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("uzcl", "l", "l12"), ("0000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_55() throws Exception {
		...
		// To be indexed: [b, c, g, i, l, m, n, o, q], to be queried: [b0, c0, g1, i1,
		// l1, m6, n10, o1, q17].
		...
		// q6]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("lvd", "b", "b0"), ("101010101010101010101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("lvd", "c", "c0"), ("100100100100100100100100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("lvd", "g", "g1"), ("010000001000000100000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("lvd", "i", "i1"), ("010000000010000000010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("lvd", "l", "l1"), ("010000000000010000000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("lvd", "m", "m6"), ("000000100000000000010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("lvd", "n", "n10"), ("000000000010000000000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("lvd", "o", "o1"), ("010000000000000010000000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("lvd", "q", "q17"), ("000000000000000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_56() throws Exception {
		...
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("ne", "c", "c0"),
				("1001001001001001001001001001001001001001001001001"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("ne", "e", "e1"),
				("0100001000010000100001000010000100001000010000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("ne", "j", "j8"),
				("0000000010000000001000000000100000000010000000001"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("ne", "l", "l12"), ("0000000000000000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols1 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p" };
		DBApp.createTable("v6d", cols1);
		// To be indexed: [b, d, e, f, g, j, k, n, o, p], to be queried: [b0, d0, e0,
		// f3, g3, j6, k2, n8, o3, p16].
		...
		// record7: [a7, b1, c1, d3, e2, f1, g0, h7, i7, j7, k7, l7, m7, n7, o7, p7]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("v6d", "b", "b0"), ("10101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("v6d", "d", "d0"), ("10001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("v6d", "e", "e0"), ("10000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("v6d", "f", "f3"), ("00010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("v6d", "g", "g3"), ("00010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("v6d", "j", "j6"), ("00000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("v6d", "k", "k2"), ("00100000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("v6d", "n", "n8"), ("00000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("v6d", "o", "o3"), ("00010000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("v6d", "p", "p16"), ("00000000"));
		// --------------------------------------------------------------------------
		String[] cols2 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q" };
		DBApp.createTable("e5u6", cols2);
		// To be indexed: [e, f, g, h, i, k, l, n, q], to be queried: [e2, f2, g1, h3,
		// i5, k4, l3, n11, q17].
		...
		// q5]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("e5u6", "e", "e2"), ("00100001000010000100001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("e5u6", "f", "f2"), ("00100000100000100000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("e5u6", "g", "g1"), ("01000000100000010000001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("e5u6", "h", "h3"), ("00010000000100000001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("e5u6", "i", "i5"), ("00000100000000100000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("e5u6", "k", "k4"), ("00001000000000010000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("e5u6", "l", "l3"), ("00010000000000010000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("e5u6", "n", "n11"), ("00000000000100000000000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("e5u6", "q", "q17"), ("00000000000000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_57() throws Exception {
		...
		// To be indexed: [b, c, g, h, j, m, p, q, r], to be queried: [b0, c0, g5, h2,
		// j3, m1, p9, q2, r18].
		...
		// p11, q10, r9]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ye7", "b", "b0"), ("1010101010101010101010101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ye7", "c", "c0"), ("1001001001001001001001001001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ye7", "g", "g5"), ("0000010000001000000100000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ye7", "h", "h2"), ("0010000000100000001000000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ye7", "j", "j3"), ("0001000000000100000000010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ye7", "m", "m1"), ("0100000000000010000000000001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ye7", "p", "p9"), ("0000000001000000000000000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ye7", "q", "q2"), ("0010000000000000000100000000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("ye7", "r", "r18"), ("0000000000000000000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_58() throws Exception {
		...
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("xebr", "c", "c1"), ("01001001001001001001001001001001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("xebr", "d", "d1"), ("01000100010001000100010001000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("xebr", "g", "g1"), ("01000000100000010000001000000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("xebr", "i", "i3"), ("00010000000010000000010000000010"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("xebr", "k", "k11"), ("00000000000000000000000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_59() throws Exception {
		...
		// To be indexed: [b, d, e, g, h, i, j, n, o, q, r], to be queried: [b0, d1, e2,
		// g2, h1, i2, j7, n4, o1, q0, r18].
		...
		// r7]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ve9o", "b", "b0"), ("10101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ve9o", "d", "d1"), ("01000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ve9o", "e", "e2"), ("00100001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ve9o", "g", "g2"), ("00100000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ve9o", "h", "h1"), ("01000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ve9o", "i", "i2"), ("00100000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ve9o", "j", "j7"), ("00000001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ve9o", "n", "n4"), ("00001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ve9o", "o", "o1"), ("01000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ve9o", "q", "q0"), ("10000000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("ve9o", "r", "r18"), ("00000000"));
		// --------------------------------------------------------------------------
		String[] cols1 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r" };
		DBApp.createTable("dvre", cols1);
		// To be indexed: [c, d, e, f, i, j, l, m, p, q, r], to be queried: [c0, d1, e1,
		// f3, i3, j2, l2, m11, p6, q7, r18].
		...
		// q7, r6]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("dvre", "c", "c0"), ("1001001001001001001001001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("dvre", "d", "d1"), ("0100010001000100010001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("dvre", "e", "e1"), ("0100001000010000100001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("dvre", "f", "f3"), ("0001000001000001000001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("dvre", "i", "i3"), ("0001000000001000000001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("dvre", "j", "j2"), ("0010000000001000000000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("dvre", "l", "l2"), ("0010000000000010000000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("dvre", "m", "m11"), ("0000000000010000000000001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("dvre", "p", "p6"), ("0000001000000000000000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("dvre", "q", "q7"), ("0000000100000000000000001"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("dvre", "r", "r18"), ("0000000000000000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_60() throws Exception {
		...
		// To be indexed: [d, f, h, j, l, m, n, r], to be queried: [d0, f0, h2, j2, l0,
		// m10, n12, r18].
		...
		// q1, r17]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("sxg", "d", "d0"), ("100010001000100010001000100010001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("sxg", "f", "f0"), ("100000100000100000100000100000100000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("sxg", "h", "h2"), ("001000000010000000100000001000000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("sxg", "j", "j2"), ("001000000000100000000010000000001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("sxg", "l", "l0"), ("100000000000100000000000100000000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("sxg", "m", "m10"), ("000000000010000000000001000000000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("sxg", "n", "n12"), ("000000000000100000000000001000000000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("sxg", "r", "r18"), ("000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols1 = { "a", "b", "c", "d", "e", "f", "g" };
		...
		// record4: [a4, b0, c1, d0, e4, f4, g4]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("wn2", "b", "b0"), ("10101"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("wn2", "c", "c0"), ("10010"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("wn2", "g", "g7"), ("00000"));
		// --------------------------------------------------------------------------
		String[] cols2 = { "a", "b", "c", "d", "e", "f", "g", "h" };
		...
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ahj", "c", "c1"), ("010010010010010010010010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ahj", "e", "e0"), ("100001000010000100001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ahj", "g", "g5"), ("000001000000100000010000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("ahj", "h", "h8"), ("000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols3 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r",
				"s" };
		DBApp.createTable("lh8", cols3);
		// To be indexed: [b, e, i, k, m, o, q, r, s], to be queried: [b0, e3, i0, k2,
		// m10, o2, q11, r1, s19].
		...
		// r0, s0]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("lh8", "b", "b0"), ("1"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("lh8", "e", "e3"), ("0"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("lh8", "i", "i0"), ("1"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("lh8", "k", "k2"), ("0"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("lh8", "m", "m10"), ("0"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("lh8", "o", "o2"), ("0"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("lh8", "q", "q11"), ("0"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("lh8", "r", "r1"), ("0"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("lh8", "s", "s19"), ("0"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_61() throws Exception {
		...
		// record12: [a12, b0, c0, d0, e2, f0, g5]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("k5d", "c", "c0"), ("1001001001001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("k5d", "e", "e0"), ("1000010000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("k5d", "f", "f4"), ("0000100000100"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("k5d", "g", "g7"), ("0000000000000"));
		// --------------------------------------------------------------------------
		String[] cols1 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l" };
		DBApp.createTable("hq", cols1);
		// To be indexed: [b, c, f, i, j, k, l], to be queried: [b0, c1, f4, i2, j7, k1,
		// l12].
		...
		// record28: [a28, b0, c1, d0, e3, f4, g0, h4, i1, j8, k6, l4]
		// record29: [a29, b1, c2, d1, e4, f5, g1, h5, i2, j9, k7, l5]
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("hq", "b", "b0"),
				("101010101010101010101010101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("hq", "c", "c1"),
				("010010010010010010010010010010"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("hq", "f", "f4"),
				("000010000010000010000010000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("hq", "i", "i2"),
				("001000000001000000001000000001"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("hq", "j", "j7"),
				("000000010000000001000000000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("hq", "k", "k1"),
				("010000000000100000000001000000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("hq", "l", "l12"), ("000000000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols2 = { "a", "b", "c", "d", "e", "f", "g" };
		...
		// record20: [a20, b0, c2, d0, e0, f2, g6]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("h1qg", "e", "e3"), ("000100001000010000100"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("h1qg", "g", "g7"), ("000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols3 = { "a", "b", "c", "d", "e", "f", "g" };
		...
		// record44: [a44, b0, c2, d0, e4, f2, g2]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("v103", "d", "d2"), ("001000100010001000100010001000100010001000100"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("v103", "g", "g7"), ("000000000000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
		...
		// record4: [a4, b0, c1, d0, e4, f4, g4, h4, i4, j4]
		// record5: [a5, b1, c2, d1, e0, f5, g5, h5, i5, j5]
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("zn", "b", "b0"),
				("101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("zn", "d", "d1"),
				("010001"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("zn", "e", "e3"),
				("000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("zn", "f", "f3"),
				("000100"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("zn", "j", "j10"), ("000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_62() throws Exception {
		...
		// record15: [a15, b1, c0, d3, e0, f3, g1]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("feby1", "b", "b0"), ("1010101010101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("feby1", "d", "d2"), ("0010001000100010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("feby1", "f", "f0"), ("1000001000001000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("feby1", "g", "g7"), ("0000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols1 = { "a", "b", "c", "d", "e", "f", "g" };
		...
		// record23: [a23, b1, c2, d3, e3, f5, g2]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("pf2", "b", "b0"), ("101010101010101010101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("pf2", "c", "c1"), ("010010010010010010010010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("pf2", "e", "e2"), ("001000010000100001000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("pf2", "f", "f3"), ("000100000100000100000100"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("pf2", "g", "g7"), ("000000000000000000000000"));
		// --------------------------------------------------------------------------
		...
		// record23: [a23, b1, c2, d3, e3, f5, g2, h7, i5, j3, k1, l11, m10]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("lub", "c", "c1"), ("010010010010010010010010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("lub", "d", "d0"), ("100010001000100010001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("lub", "e", "e2"), ("001000010000100001000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("lub", "h", "h3"), ("000100000001000000010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("lub", "k", "k8"), ("000000001000000000010000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("lub", "m", "m13"), ("000000000000000000000000"));
		// --------------------------------------------------------------------------
		...
		// record0: [a0, b0, c0, d0, e0, f0, g0, h0]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("kr5", "b", "b0"), ("1"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("kr5", "c", "c0"), ("1"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("kr5", "f", "f2"), ("0"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("kr5", "h", "h8"), ("0"));
		// --------------------------------------------------------------------------
		...
		// record37: [a37, b1, c1, d1, e2, f1, g2, h5, i1, j7, k4, l1]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("r3f1", "c", "c0"), ("10010010010010010010010010010010010010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("r3f1", "f", "f2"), ("00100000100000100000100000100000100000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("r3f1", "j", "j0"), ("10000000001000000000100000000010000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("r3f1", "k", "k2"), ("00100000000001000000000010000000000100"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("r3f1", "l", "l12"), ("00000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_63() throws Exception {
		...
		// record25: [a25, b1, c1, d1, e0, f1, g4]
		// record26: [a26, b0, c2, d2, e1, f2, g5]
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("gq", "b", "b0"),
				("101010101010101010101010101"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("gq", "c", "c0"),
				("100100100100100100100100100"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("gq", "f", "f2"),
				("001000001000001000001000001"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("gq", "g", "g7"), ("000000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols1 = { "a", "b", "c", "d", "e", "f", "g", "h", "i" };
		...
		// record39: [a39, b1, c0, d3, e4, f3, g4, h7, i3]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("y4ub", "e", "e1"), ("0100001000010000100001000010000100001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("y4ub", "g", "g1"), ("0100000010000001000000100000010000001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("y4ub", "h", "h5"), ("0000010000000100000001000000010000000100"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("y4ub", "i", "i9"), ("0000000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols2 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r",
				"s" };
		DBApp.createTable("oxfb8", cols2);
		// To be indexed: [c, f, g, i, j, k, m, n, o, p, s], to be queried: [c1, f4, g0,
		// i1, j0, k5, m8, n4, o3, p12, s19].
		...
		// q2, r0, s17]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("oxfb8", "c", "c1"), ("0100100100100100100100100100100100100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("oxfb8", "f", "f4"), ("0000100000100000100000100000100000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("oxfb8", "g", "g0"), ("1000000100000010000001000000100000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("oxfb8", "i", "i1"), ("0100000000100000000100000000100000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("oxfb8", "j", "j0"), ("1000000000100000000010000000001000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("oxfb8", "k", "k5"), ("0000010000000000100000000001000000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("oxfb8", "m", "m8"), ("0000000010000000000001000000000000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("oxfb8", "n", "n4"), ("0000100000000000001000000000000010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("oxfb8", "o", "o3"), ("0001000000000000001000000000000001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("oxfb8", "p", "p12"), ("0000000000001000000000000000100000000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("oxfb8", "s", "s19"), ("0000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_64() throws Exception {
		...
		// To be indexed: [b, c, d, e, h, i, l], to be queried: [b0, c0, d0, e0, h1, i1,
		// l12].
		...
		// record25: [a25, b1, c1, d1, e0, f1, g4, h1, i7, j5, k3, l1]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("g1c0", "b", "b0"), ("10101010101010101010101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("g1c0", "c", "c0"), ("10010010010010010010010010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("g1c0", "d", "d0"), ("10001000100010001000100010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("g1c0", "e", "e0"), ("10000100001000010000100001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("g1c0", "h", "h1"), ("01000000010000000100000001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("g1c0", "i", "i1"), ("01000000001000000001000000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("g1c0", "l", "l12"), ("00000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols1 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n" };
		DBApp.createTable("kx57b", cols1);
		// To be indexed: [b, d, e, h, i, l, n], to be queried: [b0, d0, e3, h5, i5, l3,
		// n14].
		...
		// record17: [a17, b1, c2, d1, e2, f5, g3, h1, i8, j7, k6, l5, m4, n3]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("kx57b", "b", "b0"), ("101010101010101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("kx57b", "d", "d0"), ("100010001000100010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("kx57b", "e", "e3"), ("000100001000010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("kx57b", "h", "h5"), ("000001000000010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("kx57b", "i", "i5"), ("000001000000001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("kx57b", "l", "l3"), ("000100000000000100"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("kx57b", "n", "n14"), ("000000000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_65() throws Exception {
		...
		// record27: [a27, b1, c0, d3, e2, f3, g6, h3, i0, j7, k5]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("cw0", "d", "d2"), ("0010001000100010001000100010"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("cw0", "k", "k11"), ("0000000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols1 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r",
				"s" };
		DBApp.createTable("dew2", cols1);
		// To be indexed: [b, c, d, f, g, i, n, p, q, s], to be queried: [b0, c1, d0,
		// f2, g1, i4, n2, p9, q6, s19].
		...
		// p10, q10, r10, s10]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("dew2", "b", "b0"), ("10101010101"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("dew2", "c", "c1"), ("01001001001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("dew2", "d", "d0"), ("10001000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("dew2", "f", "f2"), ("00100000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("dew2", "g", "g1"), ("01000000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("dew2", "i", "i4"), ("00001000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("dew2", "n", "n2"), ("00100000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("dew2", "p", "p9"), ("00000000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("dew2", "q", "q6"), ("00000010000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("dew2", "s", "s19"), ("00000000000"));
		// --------------------------------------------------------------------------
		String[] cols2 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m" };
		DBApp.createTable("wymj", cols2);
		// To be indexed: [b, c, d, e, f, g, i, k, l, m], to be queried: [b0, c1, d0,
		// e3, f3, g5, i6, k2, l1, m13].
		...
		// record24: [a24, b0, c0, d0, e4, f0, g3, h0, i6, j4, k2, l0, m11]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("wymj", "b", "b0"), ("1010101010101010101010101"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("wymj", "c", "c1"), ("0100100100100100100100100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("wymj", "d", "d0"), ("1000100010001000100010001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("wymj", "e", "e3"), ("0001000010000100001000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("wymj", "f", "f3"), ("0001000001000001000001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("wymj", "g", "g5"), ("0000010000001000000100000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("wymj", "i", "i6"), ("0000001000000001000000001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("wymj", "k", "k2"), ("0010000000000100000000001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("wymj", "l", "l1"), ("0100000000000100000000000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("wymj", "m", "m13"), ("0000000000000000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_66() throws Exception {
		...
		// To be indexed: [c, d, e, h, i, j, k, l, m, n, o, p, s], to be queried: [c1,
		// d2, e1, h2, i2, j6, k7, l5, m11, n4, o0, p4, s19].
		...
		// q2, r0, s17]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("zxa06", "c", "c1"), ("0100100100100100100100100100100100100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("zxa06", "d", "d2"), ("0010001000100010001000100010001000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("zxa06", "e", "e1"), ("0100001000010000100001000010000100001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("zxa06", "h", "h2"), ("0010000000100000001000000010000000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("zxa06", "i", "i2"), ("0010000000010000000010000000010000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("zxa06", "j", "j6"), ("0000001000000000100000000010000000001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("zxa06", "k", "k7"), ("0000000100000000001000000000010000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("zxa06", "l", "l5"), ("0000010000000000010000000000010000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("zxa06", "m", "m11"), ("0000000000010000000000001000000000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("zxa06", "n", "n4"), ("0000100000000000001000000000000010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("zxa06", "o", "o0"), ("1000000000000001000000000000001000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("zxa06", "p", "p4"), ("0000100000000000000010000000000000001"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("zxa06", "s", "s19"), ("0000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols1 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m" };
		...
		// record1: [a1, b1, c1, d1, e1, f1, g1, h1, i1, j1, k1, l1, m1]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("r58", "c", "c0"), ("10"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("r58", "f", "f2"), ("00"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("r58", "g", "g2"), ("00"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("r58", "h", "h1"), ("01"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("r58", "m", "m13"), ("00"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_67() throws Exception {
		...
		// record2: [a2, b0, c2, d2, e2, f2, g2]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("yh8", "b", "b0"), ("101"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("yh8", "c", "c1"), ("010"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("yh8", "g", "g7"), ("000"));
		// --------------------------------------------------------------------------
		String[] cols1 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m" };
		DBApp.createTable("vbcb2", cols1);
		// To be indexed: [d, e, f, g, h, i, j, k, l, m], to be queried: [d2, e0, f0,
		// g0, h0, i7, j2, k2, l4, m13].
		...
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("vbcb2", "d", "d2"), ("0010001000100010001000100010001000100010001000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("vbcb2", "e", "e0"), ("1000010000100001000010000100001000010000100001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("vbcb2", "f", "f0"), ("1000001000001000001000001000001000001000001000001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("vbcb2", "g", "g0"), ("1000000100000010000001000000100000010000001000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("vbcb2", "h", "h0"), ("1000000010000000100000001000000010000000100000001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("vbcb2", "i", "i7"), ("0000000100000000100000000100000000100000000100000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("vbcb2", "j", "j2"), ("0010000000001000000000100000000010000000001000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("vbcb2", "k", "k2"), ("0010000000000100000000001000000000010000000000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("vbcb2", "l", "l4"), ("0000100000000000100000000000100000000000100000000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("vbcb2", "m", "m13"), ("0000000000000000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols2 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r" };
		DBApp.createTable("ms4p", cols2);
		// To be indexed: [b, c, f, g, l, m, n, o, r], to be queried: [b0, c1, f4, g3,
		// l3, m4, n2, o11, r18].
		...
		// q2, r0]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ms4p", "b", "b0"), ("1010101010101010101010101010101010101"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ms4p", "c", "c1"), ("0100100100100100100100100100100100100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ms4p", "f", "f4"), ("0000100000100000100000100000100000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ms4p", "g", "g3"), ("0001000000100000010000001000000100000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ms4p", "l", "l3"), ("0001000000000001000000000001000000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ms4p", "m", "m4"), ("0000100000000000010000000000001000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ms4p", "n", "n2"), ("0010000000000000100000000000001000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ms4p", "o", "o11"), ("0000000000010000000000000010000000000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("ms4p", "r", "r18"), ("0000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_68() throws Exception {
		...
		// record30: [a30, b0, c0, d2, e0, f0, g2]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ol3", "d", "d0"), ("1000100010001000100010001000100"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("ol3", "g", "g7"), ("0000000000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols1 = { "a", "b", "c", "d", "e", "f", "g" };
		...
		// record18: [a18, b0, c0, d2, e3, f0, g4]
		// record19: [a19, b1, c1, d3, e4, f1, g5]
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("c1", "d", "d0"),
				("10001000100010001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("c1", "e", "e2"),
				("00100001000010000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("c1", "f", "f2"),
				("00100000100000100000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("c1", "g", "g7"), ("00000000000000000000"));
		// --------------------------------------------------------------------------
		...
		// record26: [a26, b0, c2, d2, e1, f2, g5, h2, i8]
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("h2xz9", "i", "i9"), ("000000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols3 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n" };
		DBApp.createTable("uq11g", cols3);
		// To be indexed: [d, e, f, g, h, i, l, n], to be queried: [d2, e0, f4, g5, h1,
		// i3, l9, n14].
		...
		// record15: [a15, b1, c0, d3, e0, f3, g1, h7, i6, j5, k4, l3, m2, n1]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("uq11g", "d", "d2"), ("0010001000100010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("uq11g", "e", "e0"), ("1000010000100001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("uq11g", "f", "f4"), ("0000100000100000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("uq11g", "g", "g5"), ("0000010000001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("uq11g", "h", "h1"), ("0100000001000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("uq11g", "i", "i3"), ("0001000000001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("uq11g", "l", "l9"), ("0000000001000000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("uq11g", "n", "n14"), ("0000000000000000"));
		// --------------------------------------------------------------------------
		...
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("b61", "b", "b0"), ("1010101010101010101010101010101010101010101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("b61", "f", "f3"), ("0001000001000001000001000001000001000001000001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("b61", "j", "j8"), ("0000000010000000001000000000100000000010000000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("b61", "k", "k11"), ("0000000000000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_69() throws Exception {
		...
		// To be indexed: [b, c, d, f, h, i, j, k, l], to be queried: [b0, c0, d0, f1,
		// h3, i2, j6, k8, l12].
		...
		// record37: [a37, b1, c1, d1, e2, f1, g2, h5, i1, j7, k4, l1]
		// record38: [a38, b0, c2, d2, e3, f2, g3, h6, i2, j8, k5, l2]
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("p0", "b", "b0"),
				("101010101010101010101010101010101010101"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("p0", "c", "c0"),
				("100100100100100100100100100100100100100"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("p0", "d", "d0"),
				("100010001000100010001000100010001000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("p0", "f", "f1"),
				("010000010000010000010000010000010000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("p0", "h", "h3"),
				("000100000001000000010000000100000001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("p0", "i", "i2"),
				("001000000001000000001000000001000000001"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("p0", "j", "j6"),
				("000000100000000010000000001000000000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("p0", "k", "k8"),
				("000000001000000000010000000000100000000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("p0", "l", "l12"), ("000000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_70() throws Exception {
		...
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("a8tl9", "b", "b0"), ("101010101010101010101010101010101010101010101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("a8tl9", "d", "d2"), ("001000100010001000100010001000100010001000100010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("a8tl9", "f", "f2"), ("001000001000001000001000001000001000001000001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("a8tl9", "g", "g3"), ("000100000010000001000000100000010000001000000100"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("a8tl9", "h", "h8"), ("000000000000000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols1 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k" };
		...
		// record17: [a17, b1, c2, d1, e2, f5, g3, h1, i8, j7, k6]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("pz9l4", "b", "b0"), ("101010101010101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("pz9l4", "c", "c0"), ("100100100100100100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("pz9l4", "d", "d1"), ("010001000100010001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("pz9l4", "h", "h3"), ("000100000001000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("pz9l4", "i", "i6"), ("000000100000000100"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("pz9l4", "k", "k11"), ("000000000000000000"));
		// --------------------------------------------------------------------------
		...
		// record35: [a35, b1, c2, d3, e0, f5, g0, h3, i8, j5]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("rg5dg", "b", "b0"), ("101010101010101010101010101010101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("rg5dg", "f", "f0"), ("100000100000100000100000100000100000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("rg5dg", "g", "g1"), ("010000001000000100000010000001000000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("rg5dg", "j", "j10"), ("000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols3 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r",
				"s" };
		DBApp.createTable("ms", cols3);
		// To be indexed: [b, d, h, k, l, n, p, q, r, s], to be queried: [b0, d0, h6,
		// k2, l8, n2, p14, q4, r1, s19].
		...
		// record28: [a28, b0, c1, d0, e3, f4, g0, h4, i1, j8, k6, l4, m2, n0, o13, p12,
		// q11, r10, s9]
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("ms", "b", "b0"),
				("10101010101010101010101010101"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("ms", "d", "d0"),
				("10001000100010001000100010001"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("ms", "h", "h6"),
				("00000010000000100000001000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("ms", "k", "k2"),
				("00100000000001000000000010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("ms", "l", "l8"),
				("00000000100000000000100000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("ms", "n", "n2"),
				("00100000000000001000000000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("ms", "p", "p14"), ("00000000000000100000000000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("ms", "q", "q4"),
				("00001000000000000000010000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("ms", "r", "r1"),
				("01000000000000000001000000000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("ms", "s", "s19"), ("00000000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols4 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p" };
		DBApp.createTable("wj2i", cols4);
		// To be indexed: [c, e, j, k, l, n, p], to be queried: [c0, e3, j6, k2, l10,
		// n10, p16].
		...
		// record37: [a37, b1, c1, d1, e2, f1, g2, h5, i1, j7, k4, l1, m11, n9, o7, p5]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("wj2i", "c", "c0"), ("10010010010010010010010010010010010010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("wj2i", "e", "e3"), ("00010000100001000010000100001000010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("wj2i", "j", "j6"), ("00000010000000001000000000100000000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("wj2i", "k", "k2"), ("00100000000001000000000010000000000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("wj2i", "l", "l10"), ("00000000001000000000001000000000001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("wj2i", "n", "n10"), ("00000000001000000000000010000000000000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("wj2i", "p", "p16"), ("00000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_71() throws Exception {
		...
		// To be indexed: [e, f, g, h, i, j, m], to be queried: [e0, f1, g2, h3, i7, j1,
		// m13].
		...
		// record45: [a45, b1, c0, d1, e0, f3, g3, h5, i0, j5, k1, l9, m6]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("szt3", "e", "e0"), ("1000010000100001000010000100001000010000100001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("szt3", "f", "f1"), ("0100000100000100000100000100000100000100000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("szt3", "g", "g2"), ("0010000001000000100000010000001000000100000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("szt3", "h", "h3"), ("0001000000010000000100000001000000010000000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("szt3", "i", "i7"), ("0000000100000000100000000100000000100000000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("szt3", "j", "j1"), ("0100000000010000000001000000000100000000010000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("szt3", "m", "m13"), ("0000000000000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols1 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k" };
		...
		// record2: [a2, b0, c2, d2, e2, f2, g2, h2, i2, j2, k2]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("m34", "b", "b0"), ("101"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("m34", "c", "c1"), ("010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("m34", "d", "d1"), ("010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("m34", "f", "f4"), ("000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("m34", "g", "g5"), ("000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("m34", "k", "k11"), ("000"));
		// --------------------------------------------------------------------------
		String[] cols2 = { "a", "b", "c", "d", "e", "f", "g" };
		...
		// record37: [a37, b1, c1, d1, e2, f1, g2]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("rw8", "e", "e3"), ("00010000100001000010000100001000010000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("rw8", "g", "g7"), ("00000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols3 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p" };
		DBApp.createTable("tg570", cols3);
		// To be indexed: [c, d, e, f, g, j, l, m, p], to be queried: [c1, d0, e3, f2,
		// g1, j7, l5, m3, p16].
		...
		// record46: [a46, b0, c1, d2, e1, f4, g4, h6, i1, j6, k2, l10, m7, n4, o1, p14]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("tg570", "c", "c1"), ("01001001001001001001001001001001001001001001001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("tg570", "d", "d0"), ("10001000100010001000100010001000100010001000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("tg570", "e", "e3"), ("00010000100001000010000100001000010000100001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("tg570", "f", "f2"), ("00100000100000100000100000100000100000100000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("tg570", "g", "g1"), ("01000000100000010000001000000100000010000001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("tg570", "j", "j7"), ("00000001000000000100000000010000000001000000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("tg570", "l", "l5"), ("00000100000000000100000000000100000000000100000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("tg570", "m", "m3"), ("00010000000000001000000000000100000000000010000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("tg570", "p", "p16"), ("00000000000000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols4 = { "a", "b", "c", "d", "e", "f", "g" };
		...
		// record12: [a12, b0, c0, d0, e2, f0, g5]
		// record13: [a13, b1, c1, d1, e3, f1, g6]
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("c4", "b", "b0"),
				("10101010101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("c4", "d", "d1"),
				("01000100010001"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("c4", "f", "f1"),
				("01000001000001"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("c4", "g", "g7"), ("00000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_72() throws Exception {
		...
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("i84r1", "c", "c1"), ("01001001001001001001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("i84r1", "g", "g3"), ("00010000001000000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("i84r1", "i", "i5"), ("00000100000000100000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("i84r1", "j", "j10"), ("00000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols1 = { "a", "b", "c", "d", "e", "f", "g", "h", "i" };
		DBApp.createTable("nx", cols1);
		// To be indexed: [b, c, d, e, g, h, i], to be queried: [b0, c0, d1, e2, g1, h1,
		// i9].
		...
		// record21: [a21, b1, c0, d1, e1, f3, g0, h5, i3]
		// record22: [a22, b0, c1, d2, e2, f4, g1, h6, i4]
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("nx", "b", "b0"),
				("10101010101010101010101"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("nx", "c", "c0"),
				("10010010010010010010010"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("nx", "d", "d1"),
				("01000100010001000100010"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("nx", "e", "e2"),
				("00100001000010000100001"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("nx", "g", "g1"),
				("01000000100000010000001"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("nx", "h", "h1"),
				("01000000010000000100000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("nx", "i", "i9"), ("00000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols2 = { "a", "b", "c", "d", "e", "f", "g" };
		...
		// record47: [a47, b1, c2, d3, e2, f5, g5]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("f60", "c", "c0"), ("100100100100100100100100100100100100100100100100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("f60", "d", "d2"), ("001000100010001000100010001000100010001000100010"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("f60", "g", "g7"), ("000000000000000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_73() throws Exception {
		...
		// To be indexed: [b, e, f, g, h, i, m, n], to be queried: [b0, e1, f0, g5, h4,
		// i7, m7, n14].
		...
		// record34: [a34, b0, c1, d2, e4, f4, g6, h2, i7, j4, k1, l10, m8, n6]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("c713s", "b", "b0"), ("10101010101010101010101010101010101"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("c713s", "e", "e1"), ("01000010000100001000010000100001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("c713s", "f", "f0"), ("10000010000010000010000010000010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("c713s", "g", "g5"), ("00000100000010000001000000100000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("c713s", "h", "h4"), ("00001000000010000000100000001000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("c713s", "i", "i7"), ("00000001000000001000000001000000001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("c713s", "m", "m7"), ("00000001000000000000100000000000010"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("c713s", "n", "n14"), ("00000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_74() throws Exception {
		...
		// To be indexed: [b, c, d, h, j, k, l, p], to be queried: [b0, c1, d2, h6, j6,
		// k6, l5, p16].
		...
		// record24: [a24, b0, c0, d0, e4, f0, g3, h0, i6, j4, k2, l0, m11, n10, o9, p8]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("cf3", "b", "b0"), ("1010101010101010101010101"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("cf3", "c", "c1"), ("0100100100100100100100100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("cf3", "d", "d2"), ("0010001000100010001000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("cf3", "h", "h6"), ("0000001000000010000000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("cf3", "j", "j6"), ("0000001000000000100000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("cf3", "k", "k6"), ("0000001000000000010000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("cf3", "l", "l5"), ("0000010000000000010000000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("cf3", "p", "p16"), ("0000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols1 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q" };
		DBApp.createTable("uum", cols1);
		// To be indexed: [d, e, h, k, l, m, n, q], to be queried: [d0, e3, h6, k1, l0,
		// m0, n11, q17].
		...
		// p10, q10]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("uum", "d", "d0"), ("10001000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("uum", "e", "e3"), ("00010000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("uum", "h", "h6"), ("00000010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("uum", "k", "k1"), ("01000000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("uum", "l", "l0"), ("10000000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("uum", "m", "m0"), ("10000000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("uum", "n", "n11"), ("00000000000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("uum", "q", "q17"), ("00000000000"));
		// --------------------------------------------------------------------------
		String[] cols2 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p" };
		DBApp.createTable("i94", cols2);
		// To be indexed: [c, d, f, g, i, l, m, p], to be queried: [c0, d0, f4, g5, i5,
		// l7, m10, p16].
		...
		// record24: [a24, b0, c0, d0, e4, f0, g3, h0, i6, j4, k2, l0, m11, n10, o9, p8]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("i94", "c", "c0"), ("1001001001001001001001001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("i94", "d", "d0"), ("1000100010001000100010001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("i94", "f", "f4"), ("0000100000100000100000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("i94", "g", "g5"), ("0000010000001000000100000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("i94", "i", "i5"), ("0000010000000010000000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("i94", "l", "l7"), ("0000000100000000000100000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("i94", "m", "m10"), ("0000000000100000000000010"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("i94", "p", "p16"), ("0000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols3 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r",
				"s", "t" };
		DBApp.createTable("v0", cols3);
		// To be indexed: [c, e, g, h, i, k, q, t], to be queried: [c0, e1, g5, h6, i0,
		// k0, q13, t20].
		...
		// record14: [a14, b0, c2, d2, e4, f2, g0, h6, i5, j4, k3, l2, m1, n0, o14, p14,
		// q14, r14, s14, t14]
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("v0", "c", "c0"),
				("100100100100100"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("v0", "e", "e1"),
				("010000100001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("v0", "g", "g5"),
				("000001000000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("v0", "h", "h6"),
				("000000100000001"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("v0", "i", "i0"),
				("100000000100000"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("v0", "k", "k0"),
				("100000000001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("v0", "q", "q13"), ("000000000000010"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("v0", "t", "t20"), ("000000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_75() throws Exception {
		...
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("s6474", "e", "e1"), ("0100001000010000100001000010000100001000010000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("s6474", "g", "g5"), ("0000010000001000000100000010000001000000100000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("s6474", "i", "i1"), ("0100000000100000000100000000100000000100000000100"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("s6474", "k", "k11"), ("0000000000000000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols1 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n" };
		DBApp.createTable("o8vy", cols1);
		// To be indexed: [b, c, d, f, h, j, m, n], to be queried: [b0, c1, d2, f1, h1,
		// j3, m7, n14].
		...
		// record5: [a5, b1, c2, d1, e0, f5, g5, h5, i5, j5, k5, l5, m5, n5]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("o8vy", "b", "b0"), ("101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("o8vy", "c", "c1"), ("010010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("o8vy", "d", "d2"), ("001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("o8vy", "f", "f1"), ("010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("o8vy", "h", "h1"), ("010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("o8vy", "j", "j3"), ("000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("o8vy", "m", "m7"), ("000000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("o8vy", "n", "n14"), ("000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPreIndexing_76() throws Exception {
		...
		// record17: [a17, b1, c2, d1, e2, f5, g3, h1, i8]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("yzd37", "b", "b0"), ("101010101010101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("yzd37", "c", "c1"), ("010010010010010010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("yzd37", "e", "e2"), ("001000010000100001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("yzd37", "h", "h6"), ("000000100000001000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("yzd37", "i", "i9"), ("000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols1 = { "a", "b", "c", "d", "e", "f", "g" };
		...
		// record39: [a39, b1, c0, d3, e4, f3, g4]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("h8z", "b", "b0"), ("1010101010101010101010101010101010101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("h8z", "c", "c0"), ("1001001001001001001001001001001001001001"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("h8z", "g", "g7"), ("0000000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols2 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r",
				"s", "t" };
		...
		// q12, r10, s8, t6]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("n1v7", "i", "i0"), ("10000000010000000010000000010000000010000000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("n1v7", "k", "k3"), ("00010000000000100000000001000000000010000000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("n1v7", "o", "o8"), ("00000000100000000000000100000000000000100000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("n1v7", "p", "p4"), ("00001000000000000000100000000000000010000000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("n1v7", "r", "r12"), ("00000000000010000000000000000010000000000000000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("n1v7", "t", "t20"), ("00000000000000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols3 = { "a", "b", "c", "d", "e", "f", "g" };
		...
		// record23: [a23, b1, c2, d3, e3, f5, g2]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("crhg", "b", "b0"), ("101010101010101010101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("crhg", "c", "c1"), ("010010010010010010010010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("crhg", "e", "e2"), ("001000010000100001000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("crhg", "f", "f3"), ("000100000100000100000100"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("crhg", "g", "g7"), ("000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols4 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k" };
		...
		// record28: [a28, b0, c1, d0, e3, f4, g0, h4, i1, j8, k6]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("s951s", "b", "b0"), ("10101010101010101010101010101"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("s951s", "c", "c0"), ("10010010010010010010010010010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("s951s", "h", "h3"), ("00010000000100000001000000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("s951s", "i", "i5"), ("00000100000000100000000100000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("s951s", "k", "k11"), ("00000000000000000000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPostIndexing_0() throws Exception {
		...
		// q12, r10, s8]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("iyl", "d", "d1"), ("01000100010001000100010001000100010001000100010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("iyl", "f", "f0"), ("10000010000010000010000010000010000010000010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("iyl", "j", "j7"), ("00000001000000000100000000010000000001000000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("iyl", "m", "m6"), ("00000010000000000001000000000000100000000000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("iyl", "n", "n1"), ("01000000000000010000000000000100000000000001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("iyl", "p", "p12"), ("00000000000010000000000000001000000000000000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("iyl", "q", "q3"), ("00010000000000000000100000000000000001000000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("iyl", "r", "r7"), ("00000001000000000000000001000000000000000001000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("iyl", "s", "s19"), ("00000000000000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols1 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n" };
		...
		// record9: [a9, b1, c0, d1, e4, f3, g2, h1, i0, j9, k9, l9, m9, n9]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("f1a47", "b", "b0"), ("1010101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("f1a47", "c", "c0"), ("1001001001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("f1a47", "d", "d1"), ("0100010001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("f1a47", "e", "e3"), ("0001000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("f1a47", "f", "f1"), ("0100000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("f1a47", "g", "g2"), ("0010000001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("f1a47", "j", "j8"), ("0000000010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("f1a47", "k", "k3"), ("0001000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("f1a47", "m", "m8"), ("0000000010"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("f1a47", "n", "n14"), ("0000000000"));
		// --------------------------------------------------------------------------
		String[] cols2 = { "a", "b", "c", "d", "e", "f", "g" };
		...
		// record6: [a6, b0, c0, d2, e1, f0, g6]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("z67d6", "b", "b0"), ("1010101"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("z67d6", "c", "c1"), ("0100100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("z67d6", "d", "d2"), ("0010001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("z67d6", "f", "f3"), ("0001000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("z67d6", "g", "g7"), ("0000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPostIndexing_1() throws Exception {
		...
		// last 1 records:
		// record0: [a0, b0, c0, d0, e0, f0, g0, h0, i0, j0, k0, l0, m0, n0]
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("wm", "c", "c1"),
				("0"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("wm", "e", "e0"),
				("1"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("wm", "g", "g5"),
				("0"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("wm", "h", "h5"),
				("0"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("wm", "k", "k6"),
				("0"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("wm", "n", "n14"), ("0"));
		// --------------------------------------------------------------------------
		...
		// record26: [a26, b0, c2, d2, e1, f2, g5, h2, i8, j6]
		// record27: [a27, b1, c0, d3, e2, f3, g6, h3, i0, j7]
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("f8", "f", "f0"),
				("1000001000001000001000001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("f8", "h", "h5"),
				("0000010000000100000001000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("f8", "i", "i3"),
				("0001000000001000000001000000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("f8", "j", "j10"), ("0000000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols2 = { "a", "b", "c", "d", "e", "f", "g" };
		...
		// record44: [a44, b0, c2, d0, e4, f2, g2]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("xw48i", "b", "b0"), ("101010101010101010101010101010101010101010101"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("xw48i", "c", "c0"), ("100100100100100100100100100100100100100100100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("xw48i", "d", "d1"), ("010001000100010001000100010001000100010001000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("xw48i", "g", "g7"), ("000000000000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols3 = { "a", "b", "c", "d", "e", "f", "g" };
		...
		// record18: [a18, b0, c0, d2, e3, f0, g4]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("lcunq", "c", "c0"), ("1001001001001001001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("lcunq", "f", "f0"), ("1000001000001000001"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("lcunq", "g", "g7"), ("0000000000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPostIndexing_2() throws Exception {
		...
		// record38: [a38, b0, c2, d2, e3, f2, g3]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("kl403", "b", "b0"), ("101010101010101010101010101010101010101"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("kl403", "c", "c1"), ("010010010010010010010010010010010010010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("kl403", "d", "d2"), ("001000100010001000100010001000100010001"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("kl403", "e", "e3"), ("000100001000010000100001000010000100001"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("kl403", "g", "g7"), ("000000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols1 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n" };
		...
		// record17: [a17, b1, c2, d1, e2, f5, g3, h1, i8, j7, k6, l5, m4, n3]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("p16c", "f", "f2"), ("001000001000001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("p16c", "i", "i4"), ("000010000000010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("p16c", "j", "j5"), ("000001000000000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("p16c", "k", "k0"), ("100000000001000000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("p16c", "m", "m7"), ("000000010000000000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("p16c", "n", "n14"), ("000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols2 = { "a", "b", "c", "d", "e", "f", "g" };
		...
		// record20: [a20, b0, c2, d0, e0, f2, g6]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("z3g3", "b", "b0"), ("101010101010101010101"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("z3g3", "c", "c0"), ("100100100100100100100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("z3g3", "f", "f4"), ("000010000010000010000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("z3g3", "g", "g7"), ("000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols3 = { "a", "b", "c", "d", "e", "f", "g", "h" };
		...
		// record22: [a22, b0, c1, d2, e2, f4, g1, h6]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("vusi", "b", "b0"), ("10101010101010101010101"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("vusi", "c", "c0"), ("10010010010010010010010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("vusi", "g", "g2"), ("00100000010000001000000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("vusi", "h", "h8"), ("00000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols4 = { "a", "b", "c", "d", "e", "f", "g" };
		...
		// record28: [a28, b0, c1, d0, e3, f4, g0]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("e215u", "b", "b0"), ("10101010101010101010101010101"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("e215u", "e", "e2"), ("00100001000010000100001000010"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("e215u", "g", "g7"), ("00000000000000000000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPostIndexing_3() throws Exception {
		...
		// record44: [a44, b0, c2, d0, e4, f2, g2]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("d17", "c", "c0"), ("100100100100100100100100100100100100100100100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("d17", "d", "d0"), ("100010001000100010001000100010001000100010001"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("d17", "g", "g7"), ("000000000000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols1 = { "a", "b", "c", "d", "e", "f", "g" };
		...
		// record24: [a24, b0, c0, d0, e4, f0, g3]
		// record25: [a25, b1, c1, d1, e0, f1, g4]
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("m9", "c", "c1"),
				("01001001001001001001001001"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("m9", "d", "d1"),
				("01000100010001000100010001"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("m9", "f", "f1"),
				("01000001000001000001000001"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("m9", "g", "g7"), ("00000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols2 = { "a", "b", "c", "d", "e", "f", "g" };
		...
		// record36: [a36, b0, c0, d0, e1, f0, g1]
		// record37: [a37, b1, c1, d1, e2, f1, g2]
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("r1", "c", "c1"),
				("01001001001001001001001001001001001001"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("r1", "d", "d2"),
				("00100010001000100010001000100010001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.", DBApp.getValueBits("r1", "e", "e2"),
				("00100001000010000100001000010000100001"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("r1", "g", "g7"), ("00000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPostIndexing_4() throws Exception {
		...
		// record16: [a16, b0, c1, d0, e1, f4, g2]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("sx93y", "b", "b0"), ("10101010101010101"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("sx93y", "c", "c1"), ("01001001001001001"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("sx93y", "g", "g7"), ("00000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols1 = { "a", "b", "c", "d", "e", "f", "g" };
		...
		// record42: [a42, b0, c0, d2, e2, f0, g0]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("p66", "d", "d0"), ("1000100010001000100010001000100010001000100"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("p66", "f", "f4"), ("0000100000100000100000100000100000100000100"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("p66", "g", "g7"), ("0000000000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
		String[] cols2 = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q" };
		...
		// record0: [a0, b0, c0, d0, e0, f0, g0, h0, i0, j0, k0, l0, m0, n0, o0, p0, q0]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("bez", "d", "d0"), ("1"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("bez", "h", "h2"), ("0"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("bez", "k", "k9"), ("0"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("bez", "l", "l10"), ("0"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("bez", "q", "q17"), ("0"));
		// --------------------------------------------------------------------------
		...
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("h91", "b", "b0"), ("101010101010101010101010101010101010101010101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("h91", "c", "c1"), ("010010010010010010010010010010010010010010010010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("h91", "d", "d0"), ("100010001000100010001000100010001000100010001000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("h91", "e", "e3"), ("000100001000010000100001000010000100001000010000"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("h91", "g", "g1"), ("010000001000000100000010000001000000100000010000"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("h91", "i", "i9"), ("000000000000000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
	...
	public void TableInsertionPostIndexing_5() throws Exception {
		...
		// record2: [a2, b0, c2, d2, e2, f2, g2]
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("vcacz", "g", "g7"), ("000"));
		// --------------------------------------------------------------------------
		String[] cols1 = { "a", "b", "c", "d", "e", "f", "g" };
		...
		// record37: [a37, b1, c1, d1, e2, f1, g2]
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("u2w2a", "b", "b0"), ("10101010101010101010101010101010101010"));
		assertEquals("Bitmap index should be calculated correctly for all values.",
				DBApp.getValueBits("u2w2a", "c", "c1"), ("01001001001001001001001001001001001001"));
		assertEquals("Bitmap index should return a sequence of zeros for non-present values.",
				DBApp.getValueBits("u2w2a", "g", "g7"), ("00000000000000000000000000000000000000"));
		// --------------------------------------------------------------------------
